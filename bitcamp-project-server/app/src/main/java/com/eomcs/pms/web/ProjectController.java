...
public class ProjectController {
  ...
  @GetMapping("detail")
  public String detail(int no, Model model) throws Exception { // model은 일종의 빈그릇
  ...
  @GetMapping("list")
  public String list(String item, String keyword, String title, String owner, String member, Model model) throws Exception {
